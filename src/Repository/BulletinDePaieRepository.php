...
/**
 * @extends ServiceEntityRepository<BulletinDePaie>
 *
...
class BulletinDePaieRepository extends ServiceEntityRepository
{
    ...
    public function save(BulletinDePaie $entity, bool $flush = false): void
    {
    ...
    public function remove(BulletinDePaie $entity, bool $flush = false): void
    {
